...
print(Fore.BLUE + Style.BRIGHT + custom_fig.renderText('Bypass403') + Style.RESET_ALL)
print(Fore.GREEN + Style.BRIGHT + "____________________ Mayank Rajput ____________________\n")
print(Fore.MAGENTA + Style.BRIGHT + "-----> GitHub    : https://github.com/hackelite01\n")
print(Fore.MAGENTA + Style.BRIGHT + "-----> Telegram  : https://t.me/hackelite01/\n")
print(Fore.BLUE + Style.BRIGHT + custom_fig.renderText('-------------') + Style.RESET_ALL)
# DISPLAY BANNER -- END
